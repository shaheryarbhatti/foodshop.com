...
<head>
    ...
    <title>{{ __('manage_regions') }}</title>

    @extends('layouts.app')
    @section('content')
    @php
        $user = auth()->user();
        $legacyBase = 'manage-' . \Illuminate\Support\Str::singular('regions');
        $canRegionAdd = $user && $user->canAny(['regions.add', $legacyBase . '.add']);
    @endphp
                ...
                <div class="col-sm-12">
                    <div class="card" style="margin-top: 20px;">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">{{ __('manage_regions') }}</h4>
                            @if($canRegionAdd)
                                <a href="{{ route('regions.add') }}" class="btn btn-primary">
                                    <i class="fa fa-plus me-2"></i> {{ __('add_new_region') }}
                                </a>
                            @endif
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive custom-scrollbar mb-4">
                                <table id="regionsTable" class="display table table-hover table-bordered" style="width:100%">
