...
<head>
    ...
    <title>{{ __('manage_products') }}</title>
                    ...
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('products.add') }}"
                                class="btn btn-primary"><i class="fa fa-plus me-2"></i>{{ __('add_new_product') }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
                            ...
                            <table id="productsTable" class="display table table-hover table-bordered"
                                ...
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th>#</th>
                                        <th>{{ __('image') }}</th>
                                        <th>{{ __('product_title') }}</th>
                                        <th>{{ __('category_title') }}</th>
                                        <th>{{ __('allergy_title') }}</th>
                                        <th>{{ __('product_permalink') }}</th>
                                        <th>{{ __('base_price') }}</th>
                                        <th>{{ __('status') }}</th>
                                        <th>{{ __('action') }}</th>
                                    </tr>
...
$(function() {
    ...
    $(document).on('change', '#productsTable .select-all-checkbox', function() {
