...
<head>
    ...
    <title>{{ __('add_new_organization') }}</title>
                ...
                <div class="col-12">
                    <div class="card" style="margin-top: 20px;">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">{{ __('add_new_organization') }}</h4>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('organizations.store') }}" class="theme-form">
                                @csrf
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-6 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="{{ __('organization_name') }}" required autofocus>
                                            @error('name')
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="address" id="address_search" class="form-control @error('address') is-invalid @enderror" value="{{ old('address') }}" placeholder="{{ __('organization_address_search_placeholder') }}" autocomplete="off">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="latitude" id="latitude" class="form-control @error('latitude') is-invalid @enderror" value="{{ old('latitude') }}" placeholder="e.g. 24.860734">
                                            @error('latitude')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="longitude" id="longitude" class="form-control @error('longitude') is-invalid @enderror" value="{{ old('longitude') }}" placeholder="e.g. 67.001137">
                                            @error('longitude')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 d-flex align-items-end">
                                        <div class="mb-3 w-100">
                                            ...
                                            <div class="form-text" id="coordinateHelperText">{{ __('organization_map_fetch_note') }}</div>
                                        </div>
                                    </div>
                                ...
                                <div class="text-end">
                                    <button type="submit" class="btn btn-primary px-5">
                                        <i class="fa fa-save me-2"></i> {{ __('save_organization') }}
                                    </button>
                                </div>
                            </form>
                        </div>
